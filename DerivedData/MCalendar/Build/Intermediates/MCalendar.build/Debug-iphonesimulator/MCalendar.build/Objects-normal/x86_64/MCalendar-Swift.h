...
- (void)viewDidLoad;
- (void)btn_clicked:(UIBarButtonItem * _Nonnull)sender;
- (BOOL)addEvent SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC9MCalendar11AppDelegate")
...
- (void)unHighlightWhenNotificationRecievedWithNotification:(NSNotification * _Nonnull)notification;
@end
...
@property (nonatomic, strong) UIView * _Nonnull weekview;
@property (nonatomic, copy) NSDate * _Nonnull currentSelectedDate;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull daysOfMonth;
@property (nonatomic, strong) EventsView * _Nullable eventsView;
@property (nonatomic, readonly, strong) CLLocationManager * _Nonnull locationManager;
...
- (NSInteger)getCurrentMonth SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)getCurrentYear SWIFT_WARN_UNUSED_RESULT;
- (void)loadAddEventsPage;
- (void)updatecurrentSelectedDateWithDate:(NSDate * _Nonnull)date;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)setupEventsListForCurrentDate:(NSDate * _Nonnull)forCurrentDate;
